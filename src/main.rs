            ...
            match op {
                ...
                0xCB => {
                    ...
                    match cb_op {
                        ...
                        0x19 => {
                            debug_print_op(op, "<CB> RR C", &gb);
                            let carry = gb.registers.c & 0x01;
                            let result = (gb.registers.c >> 1) | (carry << 7);
                            gb.registers.c = result;
                            gb.registers.f = 0;
                            gb.registers.f |= if result == 0 { 0b10000000 } else { 0 };
                            gb.registers.f |= if carry != 0 { 0b00010000 } else { 0 };
                        ...
                        0x1A => {
                            debug_print_op(op, "<CB> RR D", &gb);
                            let carry = gb.registers.d & 0x01;
                            let result = (gb.registers.d >> 1) | (carry << 7);
                            gb.registers.d = result;
                            gb.registers.f = 0;
                            gb.registers.f |= if result == 0 { 0b10000000 } else { 0 };
                            gb.registers.f |= if carry != 0 { 0b00010000 } else { 0 };
                        ...
                        0x1B => {
                            debug_print_op(op, "<CB> RR E", &gb);
                            let carry = gb.registers.e & 0x01;
                            let result = (gb.registers.e >> 1) | (carry << 7);
                            gb.registers.e = result;
                            gb.registers.f = 0;
                            gb.registers.f |= if result == 0 { 0b10000000 } else { 0 };
                            gb.registers.f |= if carry != 0 { 0b00010000 } else { 0 };
                        ...
                        0x1C => {
                            debug_print_op(op, "<CB> RR H", &gb);
                            let carry = gb.registers.h & 0x01;
                            let result = (gb.registers.h >> 1) | (carry << 7);
                            gb.registers.h = result;
                            gb.registers.f = 0;
                            gb.registers.f |= if result == 0 { 0b10000000 } else { 0 };
                            gb.registers.f |= if carry != 0 { 0b00010000 } else { 0 };
                        ...
                        0x26 => {
                            debug_print_op(op, "<CB> SLA (HL)", &gb);
                            let hl = ((gb.registers.h as u16) << 8) | (gb.registers.l as u16);
                            let data = gb.fetch_byte(hl);
                            let result = data << 1;
                            gb.memory[hl as usize] = result;
                        ...
                        0x30 => {
                            debug_print_op(op, "<CB> SWAP B", &gb);
                            let result =
                        ...
                        0x37 => {
                            debug_print_op(op, "<CB> SWAP A", &gb);
                            let result =
                                ((gb.registers.a & 0x0F) << 4) | ((gb.registers.a & 0xF0) >> 4);
                            gb.registers.a = result;
                            gb.registers.f = 0;
                            gb.registers.f |= if result == 0 { 0b10000000 } else { 0 };
                            gb.registers.f |= 0b01000000;
                        ...
                        0x38 => {
                            debug_print_op(op, "<CB> SRL B", &gb);
                            let carry = gb.registers.b & 0x01;
                            let result = gb.registers.b >> 1;
                            gb.registers.b = result;
                            gb.registers.f = 0;
                            gb.registers.f |= if result == 0 { 0b10000000 } else { 0 };
                        ...
                        0x40 => {
                            debug_print_op(op, "<CB> BIT 0, B", &gb);
                            gb.registers.f &= 0b10010000;
                            gb.registers.f |= if (gb.registers.b & 0x01) == 0 {
                                0b10000000
                            } else {
                        ...
                        0x45 => {
                            debug_print_op(op, "<CB> BIT 0, L", &gb);
                            gb.registers.f &= 0b10010000;
                        ...
                        0x50 => {
                            debug_print_op(op, "<CB> BIT 2, B", &gb);
                            gb.registers.f &= 0b10010000;
                        ...
                        0x51 => {
                            debug_print_op(op, "<CB> BIT 2, C", &gb);
                            gb.registers.f &= 0b10010000;
                        ...
                        0x60 => {
                            debug_print_op(op, "<CB> BIT 4, B", &gb);
                            gb.registers.f &= 0b10010000;
                            gb.registers.f |= if (gb.registers.b & 0x10) == 0 {
                                0b10000000
                            } else {
                                0
                            };
                        ...
                        0x61 => {
                            debug_print_op(op, "<CB> BIT 4, C", &gb);
                            gb.registers.f &= 0b10010000;
                            gb.registers.f |= if (gb.registers.c & 0x10) == 0 {
                                0b10000000
                            } else {
                                0
                            };
                        ...
                        0x62 => {
                            debug_print_op(op, "<CB> BIT 4, D", &gb);
                            gb.registers.f &= 0b10010000;
                            gb.registers.f |= if (gb.registers.d & 0x10) == 0 {
                                0b10000000
                            } else {
                                0
                            };
                        ...
                        0x63 => {
                            debug_print_op(op, "<CB> BIT 4, E", &gb);
                            gb.registers.f &= 0b10010000;
                            gb.registers.f |= if (gb.registers.e & 0x10) == 0 {
                                0b10000000
                            } else {
                                0
                            };
                        ...
                        0x64 => {
                            debug_print_op(op, "<CB> BIT 4, H", &gb);
                            gb.registers.f &= 0b10010000;
                            gb.registers.f |= if (gb.registers.h & 0x10) == 0 {
                                0b10000000
                            } else {
                                0
                            };
                        ...
                        0x65 => {
                            debug_print_op(op, "<CB> BIT 4, L", &gb);
                            gb.registers.f &= 0b10010000;
                            gb.registers.f |= if (gb.registers.l & 0x10) == 0 {
                                0b10000000
                            } else {
                                0
                            };
                        ...
                        0x66 => {
                            debug_print_op(op, "<CB> BIT 4, (HL)", &gb);
                            let hl = ((gb.registers.h as u16) << 8) | (gb.registers.l as u16);
                            let data = gb.fetch_byte(hl);
                            gb.registers.f &= 0b10010000;
                            gb.registers.f |= if (data & 0x10) == 0 {
                                0b10000000
                            } else {
                                0
                            };
                        ...
                        0x67 => {
                            debug_print_op(op, "<CB> BIT 4, A", &gb);
                            gb.registers.f &= 0b10010000;
                            gb.registers.f |= if (gb.registers.a & 0x10) == 0 {
                                0b10000000
                            } else {
                                0
                            };
                        ...
                        0x68 => {
                            debug_print_op(op, "<CB> BIT 5, B", &gb);
                            gb.registers.f &= 0b10010000;
                            gb.registers.f |= if (gb.registers.b & 0x20) == 0 {
                                0b10000000
                            } else {
                                0
                            };
                        ...
                        0x69 => {
                            debug_print_op(op, "<CB> BIT 5, C", &gb);
                            gb.registers.f &= 0b10010000;
                            gb.registers.f |= if (gb.registers.c & 0x20) == 0 {
                                0b10000000
                            } else {
                                0
                            };
                        ...
                        0x70 => {
                            debug_print_op(op, "<CB> BIT 6, B", &gb);
                            gb.registers.f &= 0b10010000;
                            gb.registers.f |= if (gb.registers.b & 0x40) == 0 {
                                0b10000000
                            } else {
                                0
                            };
                        ...
                        0x71 => {
                            debug_print_op(op, "<CB> BIT 6, C", &gb);
                            gb.registers.f &= 0b10010000;
                            gb.registers.f |= if (gb.registers.c & 0x40) == 0 {
                                0b10000000
                            } else {
                                0
                            };
                        ...
                        0x72 => {
                            debug_print_op(op, "<CB> BIT 6, D", &gb);
                            gb.registers.f &= 0b10010000;
                            gb.registers.f |= if (gb.registers.d & 0x40) == 0 {
                                0b10000000
                            } else {
                                0
                            };
                        ...
                        0x73 => {
                            debug_print_op(op, "<CB> BIT 6, E", &gb);
                            gb.registers.f &= 0b10010000;
                            gb.registers.f |= if (gb.registers.e & 0x40) == 0 {
                                0b10000000
                            } else {
                                0
                            };
                        ...
                        0x74 => {
                            debug_print_op(op, "<CB> BIT 6, H", &gb);
                            gb.registers.f &= 0b10010000;
                            gb.registers.f |= if (gb.registers.h & 0x40) == 0 {
                                0b10000000
                            } else {
                                0
                            };
                        ...
                        0x75 => {
                            debug_print_op(op, "<CB> BIT 6, L", &gb);
                            gb.registers.f &= 0b10010000;
                            gb.registers.f |= if (gb.registers.l & 0x40) == 0 {
                                0b10000000
                            } else {
                                0
                            };
                        ...
                        0x76 => {
                            debug_print_op(op, "<CB> BIT 6, (HL)", &gb);
                            let hl = ((gb.registers.h as u16) << 8) | (gb.registers.l as u16);
                            let data = gb.fetch_byte(hl);
                            gb.registers.f &= 0b10010000;
                            gb.registers.f |= if (data & 0x40) == 0 {
                                0b10000000
                            } else {
                                0
                            };
                        ...
                        0x77 => {
                            debug_print_op(op, "<CB> BIT 6, A", &gb);
                            gb.registers.f &= 0b10010000;
                            gb.registers.f |= if (gb.registers.a & 0x40) == 0 {
                                0b10000000
                            } else {
                                0
                            };
                        ...
                        0x78 => {
                            debug_print_op(op, "<CB> BIT 7, B", &gb);
                            gb.registers.f &= 0b10010000;
                            gb.registers.f |= if (gb.registers.b & 0x80) == 0 {
                                0b10000000
                            } else {
                        ...
                        0x79 => {
                            debug_print_op(op, "<CB> BIT 7, C", &gb);
                            gb.registers.f &= 0b10010000;
                            gb.registers.f |= if (gb.registers.c & 0x80) == 0 {
                                0b10000000
                            } else {
                        ...
                        0x7A => {
                            debug_print_op(op, "<CB> BIT 7, D", &gb);
                            gb.registers.f &= 0b10010000;
                            gb.registers.f |= if (gb.registers.d & 0x80) == 0 {
                                0b10000000
                            } else {
                        ...
                        0x6A => {
                            debug_print_op(op, "<CB> BIT 5, D", &gb);
                            gb.registers.f &= 0b10010000;
                            gb.registers.f |= if (gb.registers.d & 0x20) == 0 {
                                0b10000000
                            } else {
                                0
                            };
                        ...
                        0x6B => {
                            debug_print_op(op, "<CB> BIT 5, E", &gb);
                            gb.registers.f &= 0b10010000;
                            gb.registers.f |= if (gb.registers.e & 0x20) == 0 {
                                0b10000000
                            } else {
                                0
                            };
                        ...
                        0x6C => {
                            debug_print_op(op, "<CB> BIT 5, H", &gb);
                            gb.registers.f &= 0b10010000;
                            gb.registers.f |= if (gb.registers.h & 0x20) == 0 {
                                0b10000000
                            } else {
                                0
                            };
                        ...
                        0x6D => {
                            debug_print_op(op, "<CB> BIT 5, L", &gb);
                            gb.registers.f &= 0b10010000;
                            gb.registers.f |= if (gb.registers.l & 0x20) == 0 {
                                0b10000000
                            } else {
                                0
                            };
                        ...
                        0x6E => {
                            debug_print_op(op, "<CB> BIT 5, (HL)", &gb);
                            let hl = ((gb.registers.h as u16) << 8) | (gb.registers.l as u16);
                            let data = gb.fetch_byte(hl);
                            gb.registers.f &= 0b10010000;
                            gb.registers.f |= if (data & 0x20) == 0 {
                                0b10000000
                            } else {
                                0
                            };
                        ...
                        0x6F => {
                            debug_print_op(op, "<CB> BIT 5, A", &gb);
                            gb.registers.f &= 0b10010000;
                            gb.registers.f |= if (gb.registers.a & 0x20) == 0 {
                                0b10000000
                            } else {
                                0
                            };
                        ...
                        0xF0 => {
                            debug_print_op(op, "<CB> SET 6, B", &gb);
                            gb.registers.b |= 0x40;
                            gb.cycles += 1;
                        }
                        0xFF => {
                            debug_print_op(op, "<CB> SET 7, A", &gb);
                            gb.registers.a |= 0x80;
                            gb.cycles += 1;
                        }
                        _ => {
